        ...
        {termsOpen && (
          <div className="px-5 pb-5 space-y-3 text-xs text-gray-600 leading-relaxed border-t border-gray-100">
            ...
            <div>
              ...
              <p>You may NOT use SynthCS to generate data intended for fraud, identity theft, financial scams, or any illegal activity. Prompts that attempt to generate harmful, discriminatory, or privacy-violating datasets are strictly prohibited and will result in immediate account suspension.</p>
            </div>
            ...
            <div>
              ...
              <p>All datasets generated by SynthCS are synthetic and do NOT contain real personal information. Generated data is stored for up to 30 days and may be automatically deleted. SynthCS does NOT guarantee the statistical accuracy of generated data for production use.</p>
            </div>
        ...
        {privacyOpen && (
          <div className="px-5 pb-5 space-y-3 text-xs text-gray-600 leading-relaxed border-t border-gray-100">
            ...
            <div>
              ...
              <p>Your information is used solely to operate and improve SynthCS — to authenticate your account, display your generation history, enforce usage policies, and provide instructor oversight. We do NOT sell or share your data with third parties.</p>
            </div>
            ...
            <div>
              ...
              <p>SynthCS does NOT store the content of your input prompts beyond what is needed for schema generation. Generated datasets are synthetic — they contain NO real personal data. Your datasets are accessible only to you and authorized administrators.</p>
            </div>
